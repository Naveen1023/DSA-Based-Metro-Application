package dsa.based.metro.application;
...
public class Graph_Metro {
 ...
 /*
			...
			The type Graph_Metro.DijkstraPair must implement the inherited abstract method Comparable<Graph_Metro.DijkstraPair>.compareTo(Graph_Metro.DijkstraPair)
